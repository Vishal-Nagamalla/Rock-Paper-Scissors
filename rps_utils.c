...
void *match_thread(void *arg)
{
    ...
    while (stillPlaying) {
...

        {
            ...
            if (write_message(p1.sockfd, msg1) < 0 ||
                write_message(p2.sockfd, msg2) < 0) {
                goto cleanup;
            }
        }
